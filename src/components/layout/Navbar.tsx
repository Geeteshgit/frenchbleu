...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-999 w-full">
      {/* Navbar */}
      <div className="bg-background py-2 text-white sm:py-4">
        <Container banner className="flex items-center justify-between gap-4">
            ...
            {navigationLinks.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={clsx(
                    "relative text-lg font-semibold text-brand",
                    "after:absolute after:-bottom-1 after:left-0",
                    "after:h-0.5 after:w-full after:bg-brand",
          ...
          <button
            ...
            className="inline-flex h-11 w-11 items-center justify-center text-brand transition sm:hidden"
          >
      ...
      <WaveDivider
        ...
        mobilePath="M0 60 Q30 20 60 60 T120 60 T180 60 T240 60 T300 60 T360 60 T420 60 T480 60 T540 60 T600 60 T660 60 T720 60 T780 60 T840 60 T900 60 T960 60 T1020 60 T1080 60 T1140 60 T1200 60 T1260 60 T1320 60 T1380 60 T1440 60 L1440 120 L0 120 Z"
      />
    </header>
  );
}
